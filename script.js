...
document.addEventListener('DOMContentLoaded', function() { 
  ...
  if (contactForm) { 
    contactForm.addEventListener('submit', function(e) { 
      ...
      // Send to Zappy backend API (non-blocking)
      if (window.zappyContactFormLoaded) {
        (async function() {
          try {
            ...
            const response = await fetch('https://qaapi.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '91c0a2d6-385a-43f1-9534-888d2e2b7426',
                ...
                phone: formFields.phone || formFields.telephone || formFields.phoneNumber || null
              })
            });
            ...
            if (response.ok) {
              ...
              console.log('⚠️ Zappy: Server returned error', result);
            }
          } catch (error) {
      ...
      // Keep existing behavior - show alert and reset form
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Kong-Ping uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
